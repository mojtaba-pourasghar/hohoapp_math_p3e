...
public enum Level {
    EASY(0, "۱", "سطح ۱ — آسان", "عددهای کوچک، یک مرحله‌ای", "#3AA79A", "#E9F2E7", "#D5E5D1"),
    MEDIUM(1, "۲", "سطح ۲ — متوسط", "عددهای بزرگ‌تر و مسئله‌های کلامی", "#E8973A", "#FDF4E3", "#F0DFBE"),
    HARD(2, "۳", "سطح ۳ — سخت", "دو مرحله‌ای و ترکیبی", "#D94F7A", "#FBEAF0", "#F3D3DF");
